    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('help_text', models.TextField(blank=True, max_length=65535)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.TextField(blank=True, help_text='Field choices in JSON dictionary format.', max_length=65535)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(max_length=255)),
                ('weight', models.IntegerField(blank=True, null=True)),
                ('classes', models.CharField(blank=True, default='collapse', max_length=255)),
                ('bundle', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='fieldsets', to='dynamicadmin.Bundle')),
            ],
        ),
        migrations.AddField(
            model_name='field',
            name='fieldset',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='dynamicadmin.Fieldset'),
        ),
        migrations.AddField(
            model_name='field',
            name='polymorphic_ctype',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_dynamicadmin.field_set+', to='contenttypes.ContentType'),
        ),
        migrations.CreateModel(
